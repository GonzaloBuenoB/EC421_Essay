...
M_.exo_names(3) = {'eps_f'};
M_.exo_names_tex(3) = {'eps\_f'};
M_.exo_names_long(3) = {'eps_f'};
...
M_.endo_names(4) = {'de'};
M_.endo_names_tex(4) = {'de'};
M_.endo_names_long(4) = {'de'};
M_.endo_names(5) = {'b_star'};
M_.endo_names_tex(5) = {'b\_star'};
M_.endo_names_long(5) = {'b_star'};
M_.endo_names(6) = {'q_tilde'};
M_.endo_names_tex(6) = {'q\_tilde'};
M_.endo_names_long(6) = {'q_tilde'};
M_.endo_names(7) = {'n_star'};
M_.endo_names_tex(7) = {'n\_star'};
M_.endo_names_long(7) = {'n_star'};
M_.endo_names(8) = {'f_star'};
M_.endo_names_tex(8) = {'f\_star'};
M_.endo_names_long(8) = {'f_star'};
M_.endo_names(9) = {'i'};
...
M_.param_names(10) = {'sigma_f'};
M_.param_names_tex(10) = {'sigma\_f'};
M_.param_names_long(10) = {'sigma_f'};
...
options_.varobs(1)  = {'q_tilde'};
options_.varobs(2)  = {'de'};
options_.varobs(3)  = {'f_star'};
options_.varobs_id = [ 6 4 8  ];
...
M_.mapping.z.eqidx = [1 3 4 7 ];
M_.mapping.x.eqidx = [6 ];
M_.mapping.e.eqidx = [1 2 5 7 ];
M_.mapping.de.eqidx = [2 ];
M_.mapping.b_star.eqidx = [3 4 ];
M_.mapping.q_tilde.eqidx = [1 8 ];
M_.mapping.n_star.eqidx = [4 9 10 ];
M_.mapping.f_star.eqidx = [4 10 ];
M_.mapping.i.eqidx = [7 ];
M_.mapping.g.eqidx = [5 ];
M_.mapping.eps_q.eqidx = [8 ];
M_.mapping.eps_n.eqidx = [9 ];
M_.mapping.eps_f.eqidx = [10 ];
...
M_.block_structure.block(1).equation = [ 6 8 9 10];
M_.block_structure.block(1).variable = [ 2 6 7 8];
M_.block_structure.block(1).is_linear = true;
M_.block_structure.block(1).NNZDerivatives = 7;
M_.block_structure.block(1).bytecode_jacob_cols_to_sparse = [2 3 5 6 7 8 ];
M_.block_structure.block(2).Simulation_Type = 8;
M_.block_structure.block(2).endo_nbr = 2;
M_.block_structure.block(2).mfs = 2;
M_.block_structure.block(2).equation = [ 3 4];
M_.block_structure.block(2).variable = [ 5 1];
...
M_.block_structure.variable_reordered = [ 2 6 7 8 5 1 3 4 9 10];
M_.block_structure.equation_reordered = [ 6 8 9 10 3 4 1 2 7 5];
...
M_.dynamic_g1_sparse_rowval = int32([2 3 8 9 1 3 4 7 6 1 2 7 2 3 4 1 8 4 9 10 4 10 7 5 4 7 5 7 8 9 10 ]);
M_.dynamic_g1_sparse_colval = int32([3 5 6 7 11 11 11 11 12 13 13 13 14 15 15 16 16 17 17 17 18 18 19 20 21 21 23 23 31 32 33 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 2 2 3 4 5 5 5 5 9 10 13 14 16 18 21 23 24 25 27 27 29 29 29 29 29 29 29 29 30 31 32 ]);
...
M_.block_structure_stat.block(1).equation = [ 2 6 7];
M_.block_structure_stat.block(1).variable = [ 4 2 9];
...
M_.block_structure_stat.block(5).equation = [ 3 4];
M_.block_structure_stat.block(5).variable = [ 1 5];
...
M_.block_structure_stat.block(6).equation = [ 1 5];
M_.block_structure_stat.block(6).variable = [ 3 10];
M_.block_structure_stat.variable_reordered = [ 4 2 9 6 7 8 1 5 3 10];
M_.block_structure_stat.equation_reordered = [ 2 6 7 8 9 10 3 4 1 5];
...
M_.static_g1_sparse_rowval = int32([1 3 6 1 5 2 3 4 1 8 4 9 10 4 10 7 5 ]);
M_.static_g1_sparse_colval = int32([1 1 2 3 3 4 5 5 6 6 7 7 7 8 8 9 10 ]);
M_.static_g1_sparse_colptr = int32([1 3 4 6 7 9 11 14 16 17 18 ]);
M_.params(1) = 0.995;
beta = M_.params(1);
M_.params(2) = 0.27;
gamma = M_.params(2);
...
M_.params(8) = 0.1544;
sigma_n = M_.params(8);
M_.params(9) = 0.06703631*sqrt(1-M_.params(7)^2)/M_.params(8);
phi = M_.params(9);
M_.params(10) = 0.006703631;
sigma_f = M_.params(10);
%
...
options_.datafile = 'peru_smoother_data';
...
save([M_.dname filesep 'Output' filesep 'IM_peru_smoother_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_smoother_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_smoother_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_smoother_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_smoother_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_smoother_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_smoother_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_smoother_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
