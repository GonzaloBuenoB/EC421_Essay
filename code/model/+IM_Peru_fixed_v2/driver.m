...
M_.mapping.z.eqidx = [1 2 3 6 9 ];
M_.mapping.x.eqidx = [1 5 9 ];
M_.mapping.e.eqidx = [1 4 5 6 ];
M_.mapping.b_star.eqidx = [2 3 5 ];
M_.mapping.q_tilde.eqidx = [1 7 9 ];
M_.mapping.n_star.eqidx = [3 5 8 ];
M_.mapping.f_star.eqidx = [1 3 5 9 ];
...
M_.block_structure.block(1).equation = [ 7 8];
...
M_.block_structure.block(2).equation = [ 5 4 9 2 3 1];
M_.block_structure.block(2).variable = [ 2 9 7 4 1 3];
M_.block_structure.block(2).is_linear = false;
M_.block_structure.block(2).NNZDerivatives = 21;
M_.block_structure.block(2).bytecode_jacob_cols_to_sparse = [2 3 4 7 8 9 10 11 12 17 18 ];
...
M_.block_structure.block(2).g1_sparse_rowval = int32([1 1 1 4 1 3 6 2 3 5 6 4 5 3 4 5 6 1 6 5 2 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([2 3 4 4 7 7 7 8 9 9 9 10 10 11 11 11 11 12 12 17 18 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 1 2 3 5 5 5 8 9 12 14 18 20 20 20 20 20 21 22 ]);
...
M_.block_structure.variable_reordered = [ 5 6 2 9 7 4 1 3 8];
M_.block_structure.equation_reordered = [ 7 8 5 4 9 2 3 1 6];
...
M_.NNZDerivatives = [36; 21; -1; ];
M_.dynamic_g1_sparse_rowval = int32([2 5 7 5 8 5 5 1 2 3 6 9 1 5 9 1 5 6 2 3 1 7 9 3 8 1 3 9 6 4 3 6 4 6 7 8 ]);
M_.dynamic_g1_sparse_colval = int32([4 4 5 6 6 7 9 10 10 10 10 10 11 11 11 12 12 12 13 13 14 14 14 15 15 16 16 16 17 18 19 19 21 21 28 29 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 1 3 4 6 7 7 8 13 16 19 21 24 26 29 30 31 33 33 35 35 35 35 35 35 35 36 37 ]);
M_.dynamic_g2_sparse_indices = int32([5 12 4 ;
5 12 6 ;
5 12 7 ;
5 4 4 ;
5 4 6 ;
...
M_.block_structure_stat.block(4).equation = [ 4 5 1 2 3 9];
M_.block_structure_stat.block(4).variable = [ 9 2 3 1 4 7];
M_.block_structure_stat.variable_reordered = [ 8 5 6 9 2 3 1 4 7];
...
M_.block_structure_stat.block(4).g1_sparse_rowval = int32([1 2 2 3 6 1 2 3 3 4 6 2 4 5 2 3 5 6 ]);
M_.block_structure_stat.block(4).g1_sparse_colval = int32([1 1 2 2 2 3 3 3 4 4 4 5 5 5 6 6 6 6 ]);
M_.block_structure_stat.block(4).g1_sparse_colptr = int32([1 3 6 9 12 15 19 ]);
M_.static_g1_sparse_rowval = int32([1 2 9 1 5 9 1 4 5 2 3 5 1 7 9 3 5 8 1 3 5 9 6 4 5 ]);
M_.static_g1_sparse_colval = int32([1 1 1 2 2 2 3 3 3 4 4 4 5 5 5 6 6 6 7 7 7 7 8 9 9 ]);
M_.static_g1_sparse_colptr = int32([1 4 7 10 13 16 19 23 24 26 ]);
M_.params(1) = 0.995;
beta = M_.params(1);
M_.params(2) = 0.27;
gamma = M_.params(2);
...
save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_v2_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_v2_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_v2_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_v2_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_v2_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_v2_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_v2_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_v2_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
