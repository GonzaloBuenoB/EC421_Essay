...
M_.mapping.n_star.eqidx = [3 5 8 9 ];
M_.mapping.f_star.eqidx = [3 5 9 ];
...
M_.NNZDerivatives = [33; 21; -1; ];
M_.dynamic_g1_sparse_rowval = int32([2 5 7 5 8 5 5 1 2 3 6 1 5 1 5 6 2 3 1 7 3 8 9 3 9 6 4 3 6 4 6 7 8 ]);
M_.dynamic_g1_sparse_colval = int32([4 4 5 6 6 7 9 10 10 10 10 11 11 12 12 12 13 13 14 14 15 15 15 16 16 17 18 19 19 21 21 28 29 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 1 3 4 6 7 7 8 12 14 17 19 21 24 26 27 28 30 30 32 32 32 32 32 32 32 33 34 ]);
...
M_.static_g1_sparse_rowval = int32([1 2 1 5 1 4 5 2 3 5 1 7 3 5 8 9 3 5 9 6 4 5 ]);
M_.static_g1_sparse_colval = int32([1 1 2 2 3 3 3 4 4 4 5 5 6 6 6 6 7 7 7 8 9 9 ]);
M_.static_g1_sparse_colptr = int32([1 3 5 8 11 13 17 20 21 23 ]);
M_.params(1) = 0.995;
beta = M_.params(1);
M_.params(2) = 0.27;
gamma = M_.params(2);
M_.params(3) = 0.5000000000;
omega_bar = M_.params(3);
M_.params(4) = 0.000525;
sigma_squared = M_.params(4);
M_.params(5) = 0.8368;
rho_q = M_.params(5);
M_.params(6) = 0.038368;
sigma_q = M_.params(6);
M_.params(7) = 0.7000000000;
rho_n = M_.params(7);
M_.params(8) = 5.2500000000;
sigma_n = M_.params(8);
5.25
M_.params(9) = 0.9118762095;
phi = M_.params(9);
%
...
save([M_.dname filesep 'Output' filesep 'IM_peru_cal_work_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_cal_work_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_cal_work_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_cal_work_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_cal_work_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_cal_work_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_cal_work_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_peru_cal_work_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
