...
M_.mapping.x.eqidx = [4 ];
M_.mapping.e.eqidx = [1 ];
M_.mapping.b_star.eqidx = [2 3 ];
M_.mapping.q_tilde.eqidx = [1 5 ];
M_.mapping.n_star.eqidx = [3 6 7 ];
M_.mapping.f_star.eqidx = [3 7 ];
M_.mapping.eps_q.eqidx = [5 ];
M_.mapping.eps_n.eqidx = [6 ];
...
M_.block_structure.block(1).variable = [ 2 5 6 7];
...
M_.block_structure.variable_reordered = [ 2 5 6 7 4 1 3];
M_.block_structure.equation_reordered = [ 4 5 6 7 2 3 1];
...
M_.dynamic_g1_sparse_rowval = int32([2 5 6 1 2 3 4 1 2 3 1 5 3 6 7 3 7 3 5 6 ]);
M_.dynamic_g1_sparse_colval = int32([4 5 6 8 8 8 9 10 11 11 12 12 13 13 13 14 14 15 22 23 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 1 2 3 4 4 7 8 9 11 13 16 18 19 19 19 19 19 19 19 20 21 ]);
...
M_.block_structure_stat.variable_reordered = [ 2 5 6 7 1 4 3];
...
M_.static_g1_sparse_rowval = int32([1 2 4 1 2 3 1 5 3 6 7 3 7 ]);
M_.static_g1_sparse_colval = int32([1 1 2 3 4 4 5 5 6 6 6 7 7 ]);
M_.static_g1_sparse_colptr = int32([1 3 4 5 7 9 12 14 ]);
M_.params(1) = 0.995;
beta = M_.params(1);
M_.params(2) = 0.27;
gamma = M_.params(2);
...
save([M_.dname filesep 'Output' filesep 'IM_Peru_1b_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_1b_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_1b_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_1b_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_1b_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_1b_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_1b_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_1b_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
