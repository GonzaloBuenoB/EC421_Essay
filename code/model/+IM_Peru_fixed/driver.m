...
M_.block_structure.block(1).equation = [ 2 5 7 8 9];
M_.block_structure.block(1).variable = [ 3 9 5 6 7];
M_.block_structure.block(1).is_linear = true;
M_.block_structure.block(1).NNZDerivatives = 7;
M_.block_structure.block(1).bytecode_jacob_cols_to_sparse = [3 4 6 7 8 9 10 ];
...
M_.block_structure.block(3).variable = [ 2];
...
M_.block_structure.variable_reordered = [ 3 9 5 6 7 4 1 2 8];
M_.block_structure.equation_reordered = [ 2 5 7 8 9 3 4 1 6];
...
M_.dynamic_g1_sparse_rowval = int32([3 7 8 1 3 4 6 1 2 3 4 1 7 4 8 9 6 5 4 6 7 8 ]);
M_.dynamic_g1_sparse_colval = int32([4 5 6 10 10 10 10 11 12 13 13 14 14 15 15 16 17 18 19 19 28 29 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 1 2 3 4 4 4 4 8 9 10 12 14 16 17 18 19 21 21 21 21 21 21 21 21 21 22 23 ]);
M_.lhs = {
'0'; 
'e'; 
'beta*b_star'; 
...
M_.block_structure_stat.block(1).equation = [ 2 5 6];
M_.block_structure_stat.block(1).variable = [ 3 9 8];
...
M_.block_structure_stat.block(5).equation = [ 4 3];
M_.block_structure_stat.block(5).variable = [ 4 1];
...
M_.block_structure_stat.block(6).variable = [ 2];
M_.block_structure_stat.variable_reordered = [ 3 9 8 5 6 7 4 1 2];
M_.block_structure_stat.equation_reordered = [ 2 5 6 7 8 9 4 3 1];
...
M_.block_structure_stat.block(5).g1_sparse_rowval = int32([1 2 2 ]);
M_.block_structure_stat.block(5).g1_sparse_colval = int32([1 1 2 ]);
M_.block_structure_stat.block(5).g1_sparse_colptr = int32([1 3 4 ]);
...
M_.static_g1_sparse_rowval = int32([1 3 1 2 3 4 1 7 4 8 9 6 5 ]);
M_.static_g1_sparse_colval = int32([1 1 2 3 4 4 5 5 6 6 7 8 9 ]);
M_.static_g1_sparse_colptr = int32([1 3 4 5 7 9 11 12 13 14 ]);
M_.params(1) = 0.995;
beta = M_.params(1);
M_.params(2) = 0.27;
gamma = M_.params(2);
...
save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'IM_Peru_fixed_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
