...
//
// Observables: q_tilde, de, f_star  (3 obs <-> 3 shocks)
...
var
    ...
    de          // first difference of e: de_t = e_t - e_{t-1}
...
model(linear);
    ...
    // (ii) First difference of e (observable)
    de = e - e(-1);
