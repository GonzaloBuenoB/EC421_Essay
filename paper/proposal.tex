...
\begin{figure}[H]
    ...
    \includegraphics[width=\linewidth]{Graphics/fx_plot.png }     \label{fig:fx_plot}
 \end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.85\linewidth]{Graphics/doll_plot.png }     \label{fig:doll_plot}
 \end{figure}
